...
function addEditPointView(event) {
  const {type, price, dateFrom, dateTo} = event;
        ...
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input
              ...
              value="${humanizeDueDate(dateFrom, DATE_FORMAT_EDIT)}"
            >
            &mdash;
            ...
            <input
              ...
              type="text"
              name="event-end-time"
              value="${humanizeDueDate(dateTo, DATE_FORMAT_EDIT)}"
            >
          </div>
