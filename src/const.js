...
export {PresenterModes, MAX_PRICE, MAX_OFFER_ID,PHOTOS_COUNT,DESTINATIONS, TYPES, DATE_FORMAT_EDIT, DATE_FORMAT_POINT_DAY, DATE_FORMAT_POINT_HOURS, BLANC_TEST, POINTS_COUNT};
